...
(function(global, doc) {
    ...
    circleCollidesWithCircle = function(c1, c2) {
        var distance = Math.sqrt(Math.pow(c1.x - c2.x, 2) +
...
(function(global, doc) {
    ...
    var polygonPoints = [
            ...
            /*[new Point(310, 248), new Point(329, 248),
                new Point(329, 280), new Point(310, 280)],*/
            [new Point(76, 76), new Point(126, 76),
                new Point(126, 126), new Point(76, 126)]
        ],
        //c1 = new Circle(500, 50, 40, {x: 100, y: 100}),
        c2 = new Circle(101, 101, 25),
        p1 = new Polygon(polygonPoints[0], {x: -0, y: 0}),
        p2 = new Polygon(polygonPoints[1], {x: 0, y: -0}),
        lastLoc = {},
        shapes = [],
        shapeBeingDrag;
